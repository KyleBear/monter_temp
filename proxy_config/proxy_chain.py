...
->  Chrome 설정: socks5://127.0.0.1:1080 -> socks5://127.0.0.1:1081 -> socks5://127.0.0.1:1082 순차 할당
...
LOCAL_PROXY_PORTS = [1080, 1081, 1082] 
...
{"host": "221.153.232.136", "port": 1204}, #proxy idx 4 1203 오후 7시 사용
...
# {"host": "169.211.226.5", "port": 1207}, # proxy idx 20
...
#   {"host": "121.172.109.45","port": 1211},    
#   {"host": "211.34.241.22","port": 1213},
#   {"host": "121.172.219.42","port": 1214},
#   {"host": "220.121.87.12","port": 1215},
#   {"host": "220.126.17.47","port": 1216},
    ]
    ...
    async def connect_to_remote_proxy(self, proxy, target_host, target_port, proxy_type='socks5'):
        ...
        try:
            ...
            reader, writer = await asyncio.wait_for(
                ...
                timeout=20.0 # 기존 10초 연결지연 - 네트워크 연결 불안으로 30초로 변경 핫스팟도 20초
            )
